...
describe('Testing CodeBreaker', () => {
   describe('Testing isPositioned', () => {
      test('Get the isPositioned Endpoint', async done => {
         ...
         //Act
         const response = await request.get('/codebreaker/isPositioned?value=0&position=0');
      ...
      test('Get the isPositioned Endpoint', async done => {
         ...
         //Act
         const response = await request.get('/codebreaker/isPositioned?value=8&position=2');
   ...
   describe('Testing setSecret', () => {
      test('Get the setSecret Endpoint', async done => {
         ...
         //Act
         const response = await request.get(`/codebreaker/setsecret?value=${newSecret}`);
